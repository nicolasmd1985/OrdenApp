...
public class DBController extends SQLiteOpenHelper {
    ...
    private static final String NOMBRE_BASE_DATOS = "ordenapp26052021.db";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        query = "CREATE TABLE orders ( " +
                ...
                "fk_user_id INTEGER REFERENCES users(user_id) ON UPDATE CASCADE ON DELETE CASCADE, " +
                "description TEXT, " +
                "address TEXT, " +
                "city_id TEXT, " +
                "priority TEXT, " +
                ...
                "comment TEXT, " +
                "aux_order INTEGER DEFAULT 0)";
        sqLiteDatabase.execSQL(query);
        ///////////////THINGS//////////////////
        query = "CREATE TABLE things ( " +
                "id_thing INTEGER PRIMARY KEY, " +
                "fk_order_id TEXT REFERENCES orders(id_order) ON UPDATE CASCADE ON DELETE CASCADE , " +
                "code_scan TEXT, name TEXT, " +
                "description TEXT, " +
                "comments TEXT, " +
                "latitude TEXT, " +
                "longitude TEXT, " +
        ...
        sqLiteDatabase.execSQL(query);
        ///////////////REFERRALS//////////////////
        query = "CREATE TABLE referrals ( " +
                "id_referral INTEGER PRIMARY KEY, " +
                "fk_order_id TEXT REFERENCES orders(id_order) ON UPDATE CASCADE ON DELETE CASCADE, " +
                "comment TEXT, " +
                "signature TEXT, " +
                "full_name TEXT, " +
        ...
        sqLiteDatabase.execSQL(query);
        /////////////////UBICACION GPS//////////////////////////
        query = "CREATE TABLE GPSlogs (" +
                "id_gps INTEGER PRIMARY KEY, " +
                "longitude TEXT, " +
                "latitude TEXT )";
        sqLiteDatabase.execSQL(query);
        ///////////////CUSTOMERS//////////////////
        ...
        sqLiteDatabase.execSQL(query);
        /////////////////SUB STATUS//////////////////////////
        query = "CREATE TABLE substatus (" +
                "id_substatus INTEGER PRIMARY KEY, " +
                "substatus_type TEXT, " +
                "description TEXT, " +
                "status_id INTEGER)";
        sqLiteDatabase.execSQL(query);
...
//        description TEXT, address TEXT, city_id TEXT, priority TEXT, created_at TEXT, supervisor_id TEXT, customer_id TEXT, install_date TEXT , install_time TEXT, limit_time TEXT, category_id Text, finish INTEGER DEFAULT 0, aux_order INTEGER DEFAULT 0
        ...
        String selectQuery = "SELECT description, address, city_id, customer_id, install_time, category_id, limit_time, comment, internal_id, contact, phone_contact FROM orders where id_order = '"+id_order+"' ";
        SQLiteDatabase database = this.getWritableDatabase();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                map.put("internal_id", cursor.getString(8));
                map.put("contact", cursor.getString(9));
                map.put("phone_contact", cursor.getString(10));
